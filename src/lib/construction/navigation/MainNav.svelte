...
<div dir="ltr">
	...
	>
		...
		<div class="text-white max-md:hidden flex" dir={$pageDirection}>
			<AppRailAnchor href="/construction" title="home">
				<span
			...
			<AppRailAnchor href="/construction/about-us" title="about-us">
				<span
					class="text-xs md:text-sm lg:text-lg 2xl:text-xl font-light mx-3 lg:mx-8
				{$page.url.pathname === '/construction/about-us' ? 'border-b-2 border-primary-500' : ''}
				
				">{$t('nav.about')}</span
				>
			</AppRailAnchor>
			<AppRailAnchor href="/construction/construction" title="construction">
				<span
					class="text-xs md:text-sm lg:text-lg 2xl:text-xl font-light mx-3 lg:mx-8 {$page.url
						.pathname === '/construction/construction'
						? 'border-b-2 border-primary-500'
						: ''}">{$t('nav.construction')}</span
				>
			</AppRailAnchor>
			<AppRailAnchor href="/construction/projects" title="projects">
				<span
					class="text-xs md:text-sm lg:text-lg 2xl:text-xl font-light mx-3 lg:mx-8 {$page.url
						.pathname === '/construction/projects'
						? 'border-b-2 border-primary-500'
						: ''}">{$t('nav.projects')}</span
				>
			</AppRailAnchor>
			<AppRailAnchor href="/construction/contact-us" title="contact-us">
				<span
					class="text-xs md:text-sm lg:text-lg 2xl:text-xl font-light mx-3 lg:mx-8 {$page.url
						.pathname === '/construction/contact-us'
						? 'border-b-2 border-primary-500'
						: ''}">{$t('nav.contact')}</span
				>
			</AppRailAnchor>
